...
export default function SideQuestLock() {
  ...
  const lockedQuests = [
    { id: 'kotlin', name: 'Kotlin Native Android Apps', temptation: 'Why learn Java/JS when Kotlin is native Android standard?', lockReason: 'You are on a JavaScript-first path. Complete React Native and build Elliot\'s Android base first.', timeSaved: '120 Hours' },
    ...
    { id: 'python', name: 'Python AI & PyTorch models', temptation: 'I want to build my own local LLM model weights!', lockReason: 'Dave, you need to build the API interface first. Connect to open APIs using JS before training models.', timeSaved: '200 Hours' },
    { id: 'playstore', name: 'Google Play Store Publishing', temptation: 'Let\'s create a developer account and push alpha builds.', lockReason: 'Store setups cost money and take weeks. Keep testing on Expo Go; publish your capstone in Week 24.', timeSaved: '40 Hours' },
    { id: 'gmail', name: 'Advanced Gmail Automation APIs', temptation: 'I want Elliot to draft and delete email drafts autonomously.', lockReason: 'OAuth2 credential setups are complex and introduce security risks. Stick to local notes first.', timeSaved: '60 Hours' },
    ...
    { id: 'voice', name: 'Real-time Voice Assistant Integration', temptation: 'Let\'s add WebRTC speech recognition and text-to-speech.', lockReason: 'Voice pipelines require heavy backend resources. Complete Elliot V1 text features first.', timeSaved: '100 Hours' },
    ...
    { id: 'memory', name: 'Advanced Vector DB Long-Term Memory', temptation: 'I want to integrate Pinecone, pgvector and rag flows.', lockReason: 'Begin with standard browser localStorage memory. Move to databases after Month 5.', timeSaved: '90 Hours' },
  ];
  ...
  return (
    <PageShell>
      <PageHeader
        ...
        subtitle="Prevent shiny object syndrome. Focus strictly on Elliot V1 core milestones."
        actions={
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="card w-full max-w-md bg-navy-800 border border-navy-400 animate-scale-in text-center py-6">
            ...
            <p className="text-xs text-accent-primary font-bold uppercase tracking-wider font-mono mt-1">
              Focus Shield: 100% · Build Elliot First
            </p>
