...
import EvidenceProofStage from '../../components/missions/v2/EvidenceProofStage';
...
export default function V2Missions() {
  ...
  const evidenceState = React.useMemo(() => ({ currentByProof: evidence.currentByProof }), [evidence.currentByProof]);
  const status = getV2WeekProgress(curriculum, learner, week.id, evidenceState);
  ...
  return (
    <PageShell className="max-w-6xl">
      ...
      <main className="mt-6">
        ...
        {stage === 'proof' && <EvidenceProofStage curriculum={curriculum} week={week} learner={learner} status={status} inspectionOnly={inspectionOnly} onDraftChange={setV2ProofEvidence} />}
